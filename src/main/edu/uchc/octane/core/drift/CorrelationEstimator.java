...
public class CorrelationEstimator {
	...
	public void estimateAndCorrect(LocalizationDataset data, Rectangle roi, int numOfKeyFrames) {
	...
	public void estimate(LocalizationDataset data, Rectangle roi, int numOfKeyFrames) {
		odf = data;
